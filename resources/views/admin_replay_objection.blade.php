    ...
    <div class="page">
      ...
      <div class="content">
        ...
        <div class="replay-objection">
          ...
          <div class="content">
            <form action="{{route('store_replay',$ob->id)}}" method="post" autocomplete="off" id="objform">
            @csrf
            @if($ob->status=='pending')
              ...
              name="replay"
                required
                class="main-input"
                placeholder="What is The reasone for this objection?"
              ></textarea>
              @endif
          ...
          <div class="file" id="file">
            ...
            <div class="text">
                <p>
                انا الطالب : <bdi>{{$uu->first_name}} {{$uu->last_name}}</bdi> , من طلاب السنة :
                @if($uu->year =='First year')
                <span>
                    الأولى
                </span>
                ...
                @endif
                <br/>
                اريد تقديم اعتراض على مادة :
                <bdi> {{$ob->subject}}</bdi> القسم :
                @if($ob->oretical_partical =="Theoretical")
                <bdi>النظري , </bdi>
                @endif

                @if($ob->oretical_partical =="Partical")
                <bdi>عملي , </bdi>
                @endif
                علما ان العلامة الحاصل عليها هي :
                <span>{{$ob->mark}}</span> <br />
                والسبب في تقديم هذا الاعتراض هو :
                <span>اعتقادي بأنني يجب ان احصل على علامة أعلى</span> <br />
                ولكم جزيل الشكر
              </p>
            ...
            <div class="image">
                <img src="{{asset('profil/'.$ob->img)}}" alt="" />
            </div>
