    ...
    <div class="log">
      <div class="conatiner">
        <div class="regester-box">
          <form autocomplete="off" method="POST" action="{{ route('rdoctor.store') }}">
            @csrf
            <div class="login-title">
              <h2>Register Now</h2>
              <p>Rigster as a Professor</p>
            </div>
            <div class="page-box">
              <div class="input-box">
            ...
            @enderror
              ...
              <div class="input-boxx">
                <select name="purview">
                  <option class="op">Software</option>
                  <option class="op">Artificial Intelligence</option>
                  <option class="op">Networks</option>
                  <option class="op">Basic Siences</option>
                </select>
              </div>
              <div class="input-box">
