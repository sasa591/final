...
<html lang="en">
  ...
  <body onclick="handleClick3(event)">
      ...
      <div class="content">
        ...
        <div class="Home-content">
            <div class="objection" id="objection">
                ...
                <div class="content">
                    <form id="objform" enctype="multipart/form-data" action="{{route('downloadmaterial')}}" method="post" autocomplete="off">
                        @csrf
    ...
    text-transform: uppercase;">
                    ...
                    <input class="main-input" type="text" name="article_one" required placeholder="article one"/>

                    <input class="main-input" type="text" name="article_two" value="" placeholder="article two (optional)"/>
                    ...
                    <div class="main-input radi">
                        <div class="one">
                            <input id="TH" type="radio" value="first_chapter" required name="sub" />
                            <label for="TH">first chapter</label>
                        </div>
                        <div class="two">
                            <input id="PAR" type="radio" value="second_chapter" name="sub" />
                            <label for="PAR">second chapter</label>
                        </div>
                    </div>
        ...
        <div class="okob" id="okayobject">
            ...
            <div class="info">
            <h3>تم تقديم وثيقة تنزيل المواد بنجاح</h3>
