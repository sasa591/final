      ...
      <div class="content">
        ...
        <div class="replay-objection">
          <div class="main-heading">
            <h2>downlad materials Handling</h2>
          </div>
          <div class="content">
            <form action="{{route('store_replay_downloadmaterial',$ob->id)}}" method="post" autocomplete="off" id="objform">
            @csrf
          ...
          <div class="file" id="file">
            ...
            <h3>طلب تنزيل مواد</h3>
            <div class="text">
                <p>
                    <bdi>{{$uu->first_name}} {{$uu->last_name}}</bdi> انا الطالب
                    <br/>
                    @if($ob->second_material !=null)
                        ({{$ob->first_material}}) و ({{$ob->second_material}})أرغب التسجيل في مقرر
                    @endif

                    @if($ob->second_material ==null)
                            ({{$ob->first_material}})أرغب التسجيل في مقرر
                    @endif

                    <br>
                    @if($ob->chapter =='first_chapter' && $ob->year_of_the_artical=='First year')
                        من مقررات الفصل الدراسي الأول السنة الأولى
                    @endif
                    @if($ob->chapter =='first_chapter' && $ob->year_of_the_artical=='Second year')
                        من مقررات الفصل الدراسي الأول السنة الثانية
                    @endif

                    @if($ob->chapter =='first_chapter' && $ob->year_of_the_artical=='Third year')
                        من مقررات الفصل الدراسي الأول السنة الثالثة
                    @endif
                    @if($ob->chapter =='first_chapter' && $ob->year =='Fourth-Software' || $ob->year =='FoFourth-AI' ||$ob->year =='Fourth-Networks')
                        من مقررات الفصل الدراسي الأول السنة الرابعة
                    @endif
                    @if($ob->chapter =='first_chapter' && $ob->year =='FiFth-Software' || $ob->year =='FiFth-AI' ||$ob->year =='FiFth-Networks' )
                        من مقررات الفصل الدراسي الأول السنة الخامسة
                    @endif

                    @if($ob->chapter =='second_chapter' && $ob->year_of_the_artical=='First year')
                        من مقررات الفصل الدراسي الثاني السنة الأولى
                    @endif
                    @if($ob->chapter =='second_chapter' && $ob->year_of_the_artical=='Second year')
                        من مقررات الفصل الدراسي الثاني السنة الثانية
                    @endif

                    @if($ob->chapter =='second_chapter' && $ob->year_of_the_artical=='Third year')
                        من مقررات الفصل الدراسي الثاني السنة الثالثة
                    @endif
                    @if($ob->chapter =='second_chapter' && $ob->year =='Fourth-Software' || $ob->year =='FoFourth-AI' ||$ob->year =='Fourth-Networks')
                        من مقررات الفصل الدراسي الثاني السنة الرابعة
                    @endif
                    @if($ob->chapter =='second_chapter' && $ob->year =='FiFth-Software' || $ob->year =='FiFth-AI' ||$ob->year =='FiFth-Networks' )
                        من مقررات الفصل الدراسي الثاني السنة الخامسة
                    @endif
