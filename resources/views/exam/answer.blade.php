...
<html lang="en">
  <head>
    ...
    />
    <!-- CSS Master File -->
    <link rel="stylesheet" href="/CSS/oneQuizze.css" />
    <!-- CSS Const File -->
            ...
            <div class="questions">
                <form id="quizForm" action="{{ route('quiz.submit', $quiz->id) }}" method="POST">
                    ...
                    @foreach($quiz->questions as $question)
                        <div class="question">
                            <p>{{ $question->question_text }} (العلامة : {{ $question->mark }})</p>
                            @foreach($question->answers as $answer)
                                <div class="answer">
                                    <input type="radio" name="questions[{{ $question->id }}]" value="{{ $answer->id }}" required>
                ...
                <a href="{{route('quiz.result',$r)}}">
                        <button class="res">Result</button>
                </a>
                @endif
            </div>
          </div>
