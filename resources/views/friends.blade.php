  ...
  <body onclick="handleClick3(event)">
    ...
    <div class="page">
      ...
      <div class="content">
        ...
        <!-- End Head -->
        <!-- Start user not found image -->
        @if(count($users)==0)
        <div class="user-not-found">
          <img src="/images/user-not-found.png" alt="" />
          <div class="user-text">
            <p>Sorry</p>
            <p>There is no user by name </p>
          </div>
        </div>
        @endif
        <!-- End user not found image -->
        ...
        <div class="Home-content">
          ...
          <div class="Posts">
            ...
            <a href="{{route('notfriendsprofil',$user->id)}}">
                <div class="post">
              <div class="top">
                @if($user->img!="")
                    <img class="avatar" src="{{asset('profil/'.$user->img)}}" alt="Logo" />
                @elseif(true)
                    <img class="avatar" src="/Images/profile-image.png" alt="tttt"/>
                @endif
    ...
    <script src="JAVA/friends.js"></script>
  </body>
</html>
