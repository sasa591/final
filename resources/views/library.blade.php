  ...
  <body onclick="handleClick3(event)">
    ...
    <div class="page">
      ...
      <div class="sidebar">
            ...
            @if(auth()->user()->type=="student" || auth()->user()->type=='Professor')
            <li>
              <a class="firstA active" href="{{route('homelibrary')}}">
      ...
      <div class="content">
        ...
        <div class="Home-content">
            <div class="lectures">
                <div class="upload">
                        <form  action="{{ route('storebook') }}" method="POST"autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        <h2>Upload a Book</h2>
                        <input class="main-input" name="name" type="text" placeholder="File Name" />
                        <input class="main-input" name="about" type="text" placeholder="Overview Of the book"/>
                ...
                <div class="files">
                    ...
                    @foreach($files as $file)
                        <div>
                            <a href="{{ route('downloadbook', $file->id) }}"> <i class="fa-solid fa-download"></i> </a>
                        </div>
                        <div style="position:absolute; right:20px;" id="delete_detecting_{{$file->id}}" class="iconescom">
                            <i class="fa-solid fa-trash-can" ></i>
                        </div>
                        <div class="icon">
                            <img class="" src="images/book.png" alt="logo" />
                        </div>

                        <div class="txt-c">{{$file->name}}</div>
                        <div>   {{$file->about}}</div>
                        <div class="info">
                        ...
                        <div class="conatiner conatinercom" id="delete_confirm_inbox{{ $file->id }}">
                            <form id="delete_programmer_form_{{ $file->id }}"  action="{{route('deletebook',$file->id)}}" autocomplete="off">
