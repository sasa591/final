...
<html lang="en">
  <head>
    ...
    <title>Vision-Services-Objection</title>
  </head>
      ...
      <div class="content">
        ...
        <div class="Home-content">
            <div class="objection" id="objection">
                ...
                <div class="content">
                    <form id="objform" enctype="multipart/form-data" action="{{route('objectstor')}}" method="post" autocomplete="off">
                        @csrf
                    ...
                    <input class="main-input" name="subject" type="text" required placeholder="Subject" />
                    <div class="main-input radi">
                        <div class="one">
                            <input id="TH" type="radio" value="Theoretical" required name="sub" />
                            <label for="TH">Theoretical</label>
                        </div>
                        <div class="two">
                            <input id="PAR" type="radio" value="Partical" name="sub" />
                            <label for="PAR">Partical</label>
                        </div>
                    </div>

                    <input class="main-input" type="number" name="mark" placeholder="Mark" required/>

                    <textarea required class="main-input" name="reason_for_objection" placeholder="What is The reasone for this objection?"></textarea>

                    <input id="picture" class="main-input" name="photo" type="file" required />
                    <label for="picture" class="main-input">
        ...
        <div class="okob" id="okayobject">
            ...
            <div class="info">
            <h3>تم تقديم وثيقة الاعتراض بنجاح</h3>
