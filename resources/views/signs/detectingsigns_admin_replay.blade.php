      ...
      <div class="content">
        ...
        <div class="replay-objection">
          <div class="main-heading">
            <h2>Detectings signs Handling</h2>
          </div>
          <div class="content">
            <form action="{{route('store_replay_detectingsigns',$ob->id)}}" method="post" autocomplete="off" id="objform">
            @csrf
          ...
          <div class="file" id="file">
            ...
            <h3>طلب الحصول على كشف علامات</h3>
            <div class="text">
                <p>
               <bdi>{{$uu->first_name}} {{$uu->last_name}}</bdi> انا الطالب

                <br/>
              .أرجو التفضل بالموافقة على منحي كشف علامات  موثق أصولا .
             <br>
            ...
            <div class="image">
                ...
                <img src="{{asset('profil/'.$ob->image_clearance)}}" alt="" />
            </div>
