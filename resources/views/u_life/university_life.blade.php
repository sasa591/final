...
<html lang="en">
  ...
  <body onclick="handleClick3(event)">
      ...
      <div class="content">
        ...
        <div class="Home-content">
            <div class="objection" id="objection">
                ...
                <div class="content">
                    <form id="objform" enctype="multipart/form-data" action="{{route('universtor')}}" method="post" autocomplete="off">
                        @csrf
    ...
    text-transform: uppercase;">
                    ...
                    <input id="picture1" class="main-input" name="photoblood" type="file" required />
                    <label for="picture1" class="main-input">
                        صورة تبرع بالدم  <i class="fa-solid fa-image fa-lg"></i>
                    </label>
        ...
        <div class="okob" id="okayobject">
            ...
            <div class="info">
            <h3>تم تقديم وثيقة الحياة الجامعية بنجاح</h3>
